...
var useCaseMatrix = map[string]map[string]utils.QueryFillerMaker{
	...
	"siemens": {
		...
		siemens.LabelMovingAverage + siemens.LabelDay + siemens.LabelHour:   siemens.NewMovingAverage(24*time.Hour, time.Hour),
		siemens.LabelMovingAverage + siemens.LabelDay + siemens.LabelDay:    siemens.NewMovingAverage(24*time.Hour, 24*time.Hour),
		siemens.LabelMovingAverage + siemens.LabelMonth + siemens.LabelHour: siemens.NewMovingAverage(30*24*time.Hour, time.Hour),
		siemens.LabelMovingAverage + siemens.LabelMonth + siemens.LabelDay:  siemens.NewMovingAverage(30*24*time.Hour, 24*time.Hour),
		siemens.LabelMovingAverage + siemens.LabelMonth + siemens.LabelWeek: siemens.NewMovingAverage(30*24*time.Hour, 7*24*time.Hour),
		siemens.LabelMovingAverage + siemens.LabelYear + siemens.LabelHour:  siemens.NewMovingAverage(365*24*time.Hour, time.Hour),
		siemens.LabelMovingAverage + siemens.LabelYear + siemens.LabelDay:   siemens.NewMovingAverage(365*24*time.Hour, 24*time.Hour),
		siemens.LabelMovingAverage + siemens.LabelYear + siemens.LabelWeek:  siemens.NewMovingAverage(365*24*time.Hour, 7*24*time.Hour),
	},
}
